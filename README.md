### Hi, I'm Yupo (Jason) Niu — AI / Full-Stack Engineer based in Calgary, AB 🇨🇦

**🟢 Open to work — PGWP work-authorized, no employer sponsorship required. Available immediately for permanent full-time roles in Calgary or remote Canada.**

📬 Reach me: [yupoca24@gmail.com](mailto:yupoca24@gmail.com) · [LinkedIn](https://linkedin.com/in/yupo-niu) · [portfolio.dissidia.tech](https://portfolio.dissidia.tech) · [Resume (PDF)](https://portfolio.dissidia.tech/resume/ai-engineer.pdf)
...
`Python` `FastAPI` `LangChain` `LangGraph` `pgvector` `PyTorch` `XGBoost` · `Java` `Spring Cloud` `Kafka` `Kubernetes` · `React` `Next.js` `TypeScript` `React Native` · `PostgreSQL` `Redis` · `Docker` `GCP` `Vercel`
...
If you're hiring for **AI / LLM Engineer**, **Senior Full-Stack with AI scope**, or **AI Platform / MLOps** roles in Calgary or remote Canada — let's talk.
